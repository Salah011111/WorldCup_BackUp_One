  ...
  return (
    <Column style={{ width: '100%', flex: '1 1' }}>
      <PaddedColumn gap="14px">
        <RowBetween>
          <Text>
            {TranslateString(82, `${t('Select a token')}`)}
            <QuestionHelper
        ...
        <RowBetween>
          <Text fontSize="14px">{TranslateString(126, `${t('Token name')}`)}</Text>
        ...
        <>
          ...
          <Card>
            <RowBetween>
              ...
              >
                {selectedListInfo.current ? TranslateString(180, `${t('Change')}`) : TranslateString(1152, `${t('Select a list')}`)}
              </LinkStyledButton>
            </RowBetween>
          </Card>
        </>
