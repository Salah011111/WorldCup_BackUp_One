        ...
        {open && (
          <PopoverContainer show ref={setPopperElement as any} style={styles.popper} {...attributes.popper}>
            ...
            <ExternalLink href={`https://tokenlists.org/token-list?url=${listUrl}`}>
              {TranslateString(1206, `${t('View list')}`)}
            </ExternalLink>
    ...
    <Column style={{ width: '100%', flex: '1 1' }}>
      <PaddedColumn>
        <RowBetween>
          ...
          <Text fontSize="20px">{TranslateString(1208, `${t('Manage Lists')}`)}</Text>
        ...
        <Text bold>
          ...
          <QuestionHelper
            text={TranslateString(
              999,
              `${t('Token lists are an open specification for lists of BEP20 tokens. You can use any token list by entering its URL below. Beware that third party token lists can contain fake or malicious BEP20 tokens.')}`
