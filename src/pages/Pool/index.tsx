          ...
          <CardBody>
            <AutoColumn gap="12px" style={{ width: '100%' }}>
              <RowBetween padding="0 8px">
                ...
                <Question
                  text={TranslateString(
                    1170,
                    `${t('When you add liquidity, you are given pool tokens that represent your share. If you don’t see a pool you joined in this list, try importing a pool below.')}`
                  )}
                />
              </RowBetween>
              ...
              <div>
                ...
                <Text fontSize="14px" style={{ padding: '.5rem 0 .5rem 0' }}>
                  {TranslateString(1172, `${t('Or, if you staked your LP tokens in a farm, unstake them to see them here.')}`)}
                </Text>
              </div>
            </AutoColumn>
          </CardBody>
