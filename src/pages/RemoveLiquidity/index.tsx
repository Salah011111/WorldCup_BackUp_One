    ...
    return (
      <>
        ...
        {pair && (
          <>
            <RowBetween>
              <Text color="textSubtle">{TranslateString(1182, `${t('Price')}`)}</Text>
              <Text>
        ...
        <Button disabled={!(approval === ApprovalState.APPROVED || signatureData !== null)} onClick={onRemove}>
          {TranslateString(1136, `${t('Confirm')}`)}
        </Button>
      </>
    )
  }
            ...
            <TransactionConfirmationModal
              ...
              content={() => (
                <ConfirmationModalContent
                  title={TranslateString(1156, `${t('You will receive')}`)}
                  onDismiss={handleDismissConfirmation}
                ...
                <OutlineCard>
                  <AutoColumn>
                    <RowBetween>
                      ...
                      >
                        {showDetailed
                          ? TranslateString(1184, `${t('Simple')}`)
                          : TranslateString(1186, `${t('Detailed')}`)}
                      </ClickableText>
                    </RowBetween>
                        ...
                        {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                          <RowBetween style={{ justifyContent: 'flex-end' }}>
                            {oneCurrencyIsETH ? (
                              ...
                              >
                                {TranslateString(1188, `${t('Receive WBNB')}`)}
                              </StyledInternalLink>
                            ) : oneCurrencyIsWETH ? (
                              <StyledInternalLink
                                to={`/remove/${
                              ...
                              >
                                {TranslateString(1190,  `${t('Receive WBNB')}`)}
                              </StyledInternalLink>
                            ) : null}
                          </RowBetween>
                        ) : null}
