...
import '../SwapIndex/swapfooter.css'
import './index.css'
...
export default function AddLiquidity({
  ...
  const renderAddLiqidityPopup = () => {
    return (
      <div className='AddLiqidity'>
            ...
            <TransactionConfirmationModal
              ...
              content={() => (
                <ConfirmationModalContent
                  title={
                    noLiquidity
                      ? TranslateString(1154, `${t('You are creating a pool')}`)
                      : TranslateString(1156, `${t('You will receive')}`)
                  }
                  onDismiss={handleDismissConfirmation}
              ...
              <AutoColumn gap="20px">
                {noLiquidity && (
                  <ColumnCenter>
                    <Pane>
                      <AutoColumn gap="12px">
                        <UIKitText>{TranslateString(1158, `${t('You are the first liquidity provider.')}`)}</UIKitText>
                        <UIKitText>
                          {TranslateString(1160, `${t('The ratio of tokens you add will set the price of this pool.')}` )}
                        </UIKitText>
                        <UIKitText>
                          {TranslateString(1162,`${t('Once you are happy with the rate click supply to review.')}` )}
                        </UIKitText>
                      </AutoColumn>
                    </Pane>
                  </ColumnCenter>
                ...
                {currencies[Field.CURRENCY_A] && currencies[Field.CURRENCY_B] && pairState !== PairState.INVALID && (
                  <div>
                    ...
                    >
                      {noLiquidity
                        ? TranslateString(1164,`${t('Initial prices and pool share')}` )
                        : TranslateString(1166, `${t('Prices and pool share')}`)}
                    </UIKitText>
                    <Pane>
                      <PoolPriceBar
                        currencies={currencies}
  ...
  const renderSwapTabActive = () =>{
    return (
      <div className='tabBtn'>
        ...
        <div className='TabSwapActiveRightArea'
          role="button"
          tabIndex={0}
          onClick={()=>{ changeTab(2) }}
          >
  ...
  const renderLiquidityTabActive = () =>{
    return (
      <div className='tabBtn'>
        <div className='TabLiquidityActiveLeftArea'
          role="button"
          tabIndex={0}
          onClick={()=>{ changeTab(1) }}
